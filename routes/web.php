...
// Route untuk Order Management (Backend)
Route::get('backend/order', [OrderController::class, 'index'])->name('backend.order.index')->middleware('auth');
Route::get('backend/order/{id}/edit', [OrderController::class, 'edit'])->name('backend.order.edit')->middleware('auth');
Route::put('backend/order/{id}', [OrderController::class, 'update'])->name('backend.order.update')->middleware('auth');
Route::get('backend/order/{id}', [OrderController::class, 'show'])->name('backend.order.show')->middleware('auth');
// Route untuk laporan order
Route::get('backend/laporan/formorder', [OrderController::class, 'formOrder'])->name('backend.laporan.formorder')->middleware('auth');
Route::post('backend/laporan/cetakorder', [OrderController::class, 'cetakOrder'])->name('backend.laporan.cetakorder')->middleware('auth');
// Route untuk laporan order berdasarkan status
Route::get('backend/laporan/formorderbystatus', [OrderController::class, 'formOrderByStatus'])->name('backend.laporan.formorderbystatus')->middleware('auth');
Route::post('backend/laporan/cetakorderbystatus', [OrderController::class, 'cetakOrderByStatus'])->name('backend.laporan.cetakorderbystatus')->middleware('auth');
